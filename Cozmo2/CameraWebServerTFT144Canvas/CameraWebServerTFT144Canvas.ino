...
//const char* ssid = "NOWTVULLGG";
//const char* password = "B9PQeA1rVD9E";
...
void setup() {
  ...
  tft.drawRGBBitmap(0, 0, ttgo, 140, 140);
...
void angriFace() {
  tft.fillScreen(ST77XX_BLACK);
  tft.fillRect(10, 40, 40, 70, ST77XX_BLUE );
  tft.fillRect(60, 40, 40, 70, ST77XX_BLUE );
