      ...
      <section id="buttons">
            ...
            <div id="content">
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" id="servo-group2">
                            <label for="servo2">Servo2</label>
                            <div class="range-min">0</div>
                            <input type="range" id="servo2" min="0" max="180" value="90" class="default-action">
                            <div class="range-max">180</div>
                        </div>                      
        ...
        tracker.on('track', function(event) {
          ...
          if (rect.color=="red"&&motorState.checked) {
            ...
            var position = "";
            if (xls==0&&xrs==0) {
              result.innerHTML= "estrema sinistra";
              position = "leftfar";
            } else if (xls==0&&xrs==2) {
              result.innerHTML= "normale";
              position = "normal";
            } else if (xls==0&&xrs==1) {
              result.innerHTML= "sinistra";
              position = "left";
            } else if (xls==1&&xrs==1) {
              result.innerHTML= "normale";
              position = "normal";
            } else if (xls==1&&xrs==2) {
              result.innerHTML= "Destra";
              position = "right";
            } else if (xls==2&&xrs==2) {
              result.innerHTML= "lontano a destra";
              position = "rightfar";
            } else {
              result.innerHTML= "indistinguibile";
              position = "";
            }
